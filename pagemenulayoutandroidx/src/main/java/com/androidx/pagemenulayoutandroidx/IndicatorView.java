...
public class IndicatorView extends View {
    ...
    public IndicatorView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        init();
        if (attrs != null) {
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.PageMenuLayout);
            indicatorColor = typedArray.getColor(R.styleable.PageMenuLayout_indicatorColor, Color.rgb(0, 0, 0));
            indicatorColorSelected = typedArray.getColor(R.styleable.PageMenuLayout_indicatorColorSelected, Color.rgb(0, 0, 0));
            indicatorWidth = ScreenUtil.dip2px(typedArray.getInt(R.styleable.PageMenuLayout_indicatorWidth, 0));
            gravity = typedArray.getInt(R.styleable.PageMenuLayout_gravity, 0);
            typedArray.recycle();
        }
    }
